...
# Reading Data
print("Reading Data...")
x_train, y_train = load_images_from_csv("CSVS/FULL_DATASETS/FULL_DATASET_PER_CLIENT_WITH_VAL/train_WITH_VAL.csv")
x_test, y_test = load_images_from_csv("CSVS/FULL_DATASETS/FULL_DATASET_PER_CLIENT_WITH_VAL/validation.csv")
