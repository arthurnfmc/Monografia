...
class HuggingFaceClient(fl.client.NumPyClient):
    def __init__(self, train_csv_path, val_csv_path, local_epochs=4, model_name='google/vit-base-patch16-224-in21k'):
        ...
        augmented_images, augmented_labels = data_augmentation(original_images, train_dataset['labels'])
