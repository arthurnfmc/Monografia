...
GLOBAL_EPOCHS         = 20
VERBOSE               = 1
OUTPUT_DIR            = "ActualReport-3_CLIENTS-SUBDIVIDED_DATASET-AUGMENTED-5_FOLDS/FOLD_5"
FRACTION_FIT          = 1
FRACTION_EVALUATE     = 1
MIN_FIT_CLIENTS       = 3
...
DECAY_FACTOR          = 0.9
EXTRA_NOTES           = "Server On Maeve. 2 clients on nevasca, 1 clients on cisco, 0 on maeve"

if os.path.exists(os.path.join(os.curdir, "LOGS", OUTPUT_DIR)):
  print("ERROR: Output Dir Already Exists!")
  exit(1)
os.makedirs(os.path.join(os.curdir, "LOGS", OUTPUT_DIR))
